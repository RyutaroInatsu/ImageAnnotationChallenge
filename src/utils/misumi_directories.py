...
class MisumiDirectories:
    ...
    def __init__(self, misumi_dataset_rootpath):
        ...
        self.screws_bolts_list = [
            "captive_washer_screws",
            "cross_recessed_bolts",
            "eye_screws_bolts",
            "fastener_accessories",
            "fully-threaded_bolts",
            "hex_bolts",
            "hex_socket_button_head_cap",
            "hex_socket_flat_head_cap",
            "hex_socket_head_cap",
            "micro_screws_precise_screws",
            "plastic_ceramic_screws",
            "self_tapping_screws",
            "set_screws",
            "small_head_bolts",
            "space_saving_bolts",
            "strippers_reamers_shoulder_bolts",
            "tamper_resistant_screws",
            "vented_screws",
            "wing_thumb_ornamental",
        ]

        self.shims_list = ["rectangular", "plates", "rings", "tape"]

        self.washers_list = [
            "metal",
            "non-metal_and_collars",
            "urethane_rubber_sponge_felt",
        ]
        ...
        self.lan_and_industrial_network_cables_list = [
            "lan_cable_with_connector",
            "lan_network_cable",
            "fiber_optic_cable_accessories",
            "lan_cable_connector_accessories",
            "network_cable_adapters",
            "network_cable_connectors",
            "telephone_cable",
            "fiber_optic_cable",
        ]

        self.equipment_specific_cables_list = [
            "ac_servo_motor_cables",
            "cordset_accessories",
            "io_board_cables",
            "image_sonsor_cables",
            "plc_cables",
            "relay_terminal_cables",
            "sensor_cordsets",
            "single_axis_robot_cables",
            "stepper_motor_cables",
            "touch_panel_cables",
            "solenoid_valve_compatible_cable",
        ]

        self.cordsets_list = [
            "circular",
            "coaxial",
            "conversion_branching",
            "nylon_connector",
            "square",
        ]
        ...
        self.cable_bushings_clip_stickers_list = ["bushings", "clips", "stickers"]

        self.cable_organization_list = ["ties", "tie_mount_accessories"]

        self.cable_gland_list = ["components", "accessories"]
        ...
        self.crimp_terminal_components_list = [
            "crimp_terminals",
            "crimp_terminal_accessories",
        ]

        self.electrical_conduits_list = [
            "metal",
            "metal_conduits_accessories",
            "plastic",
            "plastic_conduits_accessories",
        ]

        self.electrical_tubing_list = [
            "braided_sleeves",
            "cable_sleeving",
            "electrical_tubing_accessories",
            "general_purpose_tubing",
            "heat_shrink_tubing",
            "spiral_wraps",
        ]
        ...
        self.electrical_wiring_tools = [
            "cable_tile_tools",
            "crimping_idc_tools",
            "electrical_wiring_tool_accessories",
            "wire_cutting_tools",
            "wiring_connection_screwdrivers",
            "wiring_tweezers_wranches",
            "wiring_stripper_tools",
        ]

        self.soldering_supplies_list = ["soldering_tools", "soldering_iron_holders"]

        self.specialized_wiring_tools = [
            "connector_tools",
            "specialized_wiring_tool_accessories",
            "terminal_removal_tools",
        ]
    ...
    def __call__(self):
        ...
        self._create_dirs(
            self.lan_and_industrial_network_cables_list, suffix="lanAndIndustrial_"
        )
        self._create_dirs(
            self.equipment_specific_cables_list, suffix="equipmentSpecific_"
        )
        ...
        self._create_dirs(
            self.cable_bushings_clip_stickers_list, suffix="cableBushing_"
        )
