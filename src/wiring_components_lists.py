...
equipment_specific_cables_list = [
...
electrical_tubingand_sleeving_list =[
...
soldering_supplies_list = [
    ['Soldering tools', 'はんだ付け工具'],
    ['Soldering iron holders', 'はんだごてホルダー']
]
...
wire_ducts_and_cable_raceways_list = [
    ['Cable raceways', 'モール'],
...
wiring_component_dict = {
    "LAN & Industrial Network cables" : lan_and_indutrial_network_cables_list,
    ...
    "Crimp terminal components" : crimp_terminal_components_list,
    "Electrical conduits" : electrical_conduits_list,
    "Electrical Tubing & sleeving" : electrical_tubingand_sleeving_list,
    "Electrical wiring tools" : electrical_wiring_tools_list,
    "Screw & spacer components" : ["Screw & spacer components", "ネジ･スペーサー"],
    "Soldering supplies" : soldering_supplies_list,
    "Specialized wiring tools" : specialized_wiring_tools_list,
    "Wire & Cable" : wire_and_cable_list,
    "Wiring connectors" : wiring_connectors_list,
    "Wire ducts & cable raceways": wire_ducts_and_cable_raceways_list
}

if __name__ == '__main__':
	for item in wiring_component_dict:
		print(f'Key is {item}. Values are {wiring_component_dict[item]}')